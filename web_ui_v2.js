...
WebUI.initWidgets = function() {
    WebUI.app = new WebUI.Row({
        children:[
              ...
              new WebUI.TextField("0",{width:600, height:50}),
          new WebUI.Column({
            children:[
...
WebUI.MyPushButton.prototype.handleButtonPushed = function(str) {
  ...
  {
      if(WebUI.widgets[1].visual_items[1].text == "0")
      {
          WebUI.widgets[1].visual_items[1].text = str;
      }
      else
      {
          WebUI.widgets[1].visual_items[1].text += str;
  ...
  {
      if(WebUI.widgets[1].visual_items[1].text == "function")
      {
          WebUI.widgets[1].visual_items[1].text = str;
      }
      else if(tempStr == "CL")
      {
           WebUI.widgets[1].visual_items[1].text = "0";
      }
      else if(WebUI.widgets[1].visual_items[1].text == "0")
      {
          WebUI.widgets[1].visual_items[1].text = str;
      }
      else if(str == "EV")
      {
          try
          {
              ...
              checkFunc = WebUI.widgets[1].visual_items[1].text;
              ...
              if(checkFunc[0] == "f" && checkFunc[cFunc] =="=")
              {
                  ...
                  WebUI.widgets[1].visual_items[1].text = "function";
              }
              ...
              {
                  result = eval(WebUI.widgets[1].visual_items[1].text);
                  WebUI.widgets[1].visual_items[1].text=result.toString();
              }
              WebUI.x = x; WebUI.y = y; WebUI.z = z;
          }
          catch(e)
          {
              WebUI.widgets[1].visual_items[1].text = "Error";
          }
      }
      else
      {
